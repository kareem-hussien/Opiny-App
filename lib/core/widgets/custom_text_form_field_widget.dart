...
class CustomTextFormFieldWidget extends StatelessWidget {
  ...
  const CustomTextFormFieldWidget({
    ...
    this.focusNode, this.prefixIconColor, this.suffixIconColor,
  });
  ...
  Widget build(BuildContext context) {
    return TextFormField(
      style: textStyle ??
          TextStyle(fontSize: 14.sp, color: const Color(0XFF4F46E5)),
      ...
      decoration: InputDecoration(
        ...
        labelText: labelText,
        hintStyle: hintStyle ??
            TextStyle(fontSize: 14.sp, color: const Color(0XFFADAEBC)),
        hintText: hintText,
